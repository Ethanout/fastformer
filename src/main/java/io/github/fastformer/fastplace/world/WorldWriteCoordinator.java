...
public final class WorldWriteCoordinator {
   ...
   public static synchronized boolean tryAcquire(Object server, ResourceKey<Level> dimension, UUID owner) {
   ...
   public static synchronized void release(Object server, ResourceKey<Level> dimension, UUID owner) {
