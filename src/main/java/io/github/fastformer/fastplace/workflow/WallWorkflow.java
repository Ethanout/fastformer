...
public final class WallWorkflow implements GeometryWorkflow {
   @Override
   ...
   public static BlockPos raycastPoint(GeometryHit hit, boolean embedded) {
