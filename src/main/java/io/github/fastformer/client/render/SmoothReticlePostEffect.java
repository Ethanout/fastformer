 ...
 */
public final class SmoothReticlePostEffect {
   ...
   public static boolean updateTarget(ModifierReticleMode mode) {
   ...
   public static boolean process(Minecraft minecraft, float partialTicks) {
